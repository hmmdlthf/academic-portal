        ...
        <div class="body">
            ...
            <div class="body__content">
                <?php if (count($notes) > 0) { ?>
                    ...
                    <button class="btn btn__primary" onclick="document.location = '/teacher/note/addNote.php'">Add New Note</button>
                    <div class="items">
                        <table>
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <?php foreach ($notes as $note) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="actions">
                                                <div class="deleteBtn" onclick="document.location = '/teacher/note/deleteNote.php?id=<?php echo $note->getId(); ?>'">
                                                ...
                                                <div class="editBtn" onclick="document.location = '/teacher/note/updateNote.php?id=<?php echo $note->getId(); ?>'">
