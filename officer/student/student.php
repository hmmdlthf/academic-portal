        ...
        <div class="body">
            ...
            <div class="body__content">
                <?php if (count($students) > 0) { ?>
                    ...
                    <button class="btn btn__primary" onclick="document.location = '/officer/student/addStudent.php?link=add%20student'">Add New Student</button>
                    <div class="items">
                        <table>
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <?php foreach ($students as $student) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="actions">
                                                <div class="deleteBtn" onclick="document.location = '/officer/student/deleteStudent.php?id=<?php echo $student->getId(); ?>'">
                                                ...
                                                <div class="editBtn" onclick="document.location = '/officer/student/updateStudent.php?id=<?php echo $student->getId(); ?>'">
