        ...
        <div class="body">
            ...
            <div class="body__content">
                <?php if (count($answerSheets) > 0) { ?>
                    ...
                    <button class="btn btn__primary" onclick="document.location = '/admin/answerSheet/addAnswerSheet.php?link=add%20answer%20sheet'">Add New Answer Sheet</button>
                    <div class="items">
                        <table>
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <?php foreach ($answerSheets as $answerSheet) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="actions">
                                                <div class="deleteBtn" onclick="document.location = '/admin/answerSheet/deleteAnswerSheet.php?id=<?php echo $answerSheet->getId(); ?>'">
                                                ...
                                                <div class="editBtn" onclick="document.location = '/admin/answerSheet/updateAnswerSheet.php?id=<?php echo $answerSheet->getId(); ?>'">
