    ...
    <div class="main">
        ...
        <div class="body">
            ...
            <?php if (count($officers) > 0) { ?>
                    ...
                    <button class="btn btn__primary" onclick="document.location = '/admin/officer/addOfficer.php?link=add%20officer'">Add New Officer</button>
                    <div class="items">
                        <table>
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <?php foreach ($officers as $officer) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="actions">
                                                <div class="deleteBtn" onclick="document.location = '/admin/officer/deleteOfficer.php?id=<?php echo $officer->getId(); ?>'">
                                                ...
                                                <div class="editBtn" onclick="document.location = '/admin/officer/updateOfficer.php?id=<?php echo $officer->getId(); ?>'">
