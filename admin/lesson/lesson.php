        ...
        <div class="body">
            ...
            <div class="body__content">
                <?php if (count($lessons) > 0) { ?>
                    ...
                    <button class="btn btn__primary" onclick="document.location = '/admin/lesson/addLesson.php?link=add%20lesson'">Add New Lesson</button>
                    <div class="items">
                        <table>
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <?php foreach ($lessons as $lesson) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="actions">
                                                <div class="deleteBtn" onclick="document.location = '/admin/lesson/deleteLesson.php?id=<?php echo $lesson->getId(); ?>'">
                                                ...
                                                <div class="editBtn" onclick="document.location = '/admin/lesson/updateLesson.php?id=<?php echo $lesson->getId(); ?>'">
