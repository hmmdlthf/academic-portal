    ...
    <div class="main">
        ...
        <div class="body">
            ...
            <?php if (count($teachers) > 0) { ?>
                    ...
                    <button class="btn btn__primary" onclick="document.location = '/admin/teacher/addTeacher.php?link=add%20teacher'">Add New Teacher</button>
                    <div class="items">
                        <table>
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <?php foreach ($teachers as $teacher) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="actions">
                                                <div class="deleteBtn" onclick="document.location = '/admin/teacher/deleteTeacher.php?id=<?php echo $teacher->getId(); ?>'">
                                                ...
                                                <div class="editBtn" onclick="document.location = '/admin/teacher/updateTeacher.php?id=<?php echo $teacher->getId(); ?>'">
