        ...
        <div class="body">
            ...
            <div class="body__content">
                <?php if (count($subjects) > 0) { ?>
                    ...
                    <button class="btn btn__primary" onclick="document.location = '/admin/subject/addSubject.php?link=add%20subject'">Add New Subject</button>
                    <div class="items">
                        <table>
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <?php foreach ($subjects as $subject) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="actions">
                                                <div class="deleteBtn" onclick="document.location = '/admin/subject/deleteSubject.php?id=<?php echo $subject->getId(); ?>'">
                                                ...
                                                <div class="editBtn" onclick="document.location = '/admin/subject/updateSubject.php?id=<?php echo $subject->getId(); ?>'">
