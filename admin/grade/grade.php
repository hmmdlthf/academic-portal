        ...
        <div class="body">
            ...
            <div class="body__content">
                <?php if (count($grades) > 0) { ?>
                    ...
                    <button class="btn btn__primary" onclick="document.location = '/admin/grade/addGrade.php?link=add%20grade'">Add New Grade</button>
                    <div class="items">
                        <table>
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <?php foreach ($grades as $grade) { ?>
                                    <tr>
                                        ...
                                        <td><?php echo $grade->getOrder(); ?></td>
                                        <td>
                                            <div class="actions">
                                                <div class="deleteBtn" onclick="document.location = '/admin/grade/deleteGrade.php?id=<?php echo $grade->getId(); ?>'">
                                                ...
                                                <div class="editBtn" onclick="document.location = '/admin/grade/updateGrade.php?id=<?php echo $grade->getId(); ?>'">
