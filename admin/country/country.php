        ...
        <div class="body">
            ...
            <div class="body__content">
                <?php if (count($countries) > 0) { ?>
                    ...
                    <button class="btn btn__primary" onclick="document.location = '/admin/country/addCountry.php?link=add%20country'">Add New Country</button>
                    <div class="items">
                        <table>
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <?php foreach ($countries as $country) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="actions">
                                                <div class="deleteBtn" onclick="document.location = '/admin/country/deleteCountry.php?id=<?php echo $country->getId(); ?>'">
                                                ...
                                                <div class="editBtn" onclick="document.location = '/admin/country/updateCountry.php?id=<?php echo $country->getId(); ?>'">
