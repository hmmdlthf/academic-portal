        ...
        <div class="body">
            ...
            <div class="body__content">
                <?php if (count($cities) > 0) { ?>
                    ...
                    <button class="btn btn__primary" onclick="document.location = '/admin/city/addCity.php?link=add%20city'">Add New City</button>
                    <div class="items">
                        <table>
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <?php foreach ($cities as $city) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="actions">
                                                <div class="deleteBtn" onclick="document.location = '/admin/city/deleteCity.php?id=<?php echo $city->getId(); ?>'">
                                                ...
                                                <div class="editBtn" onclick="document.location = '/admin/city/updateCity.php?id=<?php echo $city->getId(); ?>'">
