        ...
        <div class="body">
            ...
            <div class="body__content">
                <?php if (count($assignments) > 0) { ?>
                    ...
                    <button class="btn btn__primary" onclick="document.location = '/admin/assignment/addAssignment.php?link=add%20assignment'">Add New Assignment</button>
                    <div class="items">
                        <table>
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <?php foreach ($assignments as $assignment) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="actions">
                                                <div class="deleteBtn" onclick="document.location = '/admin/assignment/deleteAssignment.php?id=<?php echo $assignment->getId(); ?>'">
                                                ...
                                                <div class="editBtn" onclick="document.location = '/admin/assignment/updateAssignment.php?id=<?php echo $assignment->getId(); ?>'">
