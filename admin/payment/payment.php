        ...
        <div class="body">
            ...
            <div class="body__content">
                <?php if (count($payments) > 0) { ?>
                    ...
                    <button class="btn btn__primary" onclick="document.location = '/admin/payment/addPayment.php?link=add%20payment'">Add New Payment</button>
                    <div class="items">
                        <table>
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <?php foreach ($payments as $payment) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="actions">
                                                <div class="deleteBtn" onclick="document.location = '/admin/payment/deletePayment.php?id=<?php echo $payment->getId(); ?>'">
                                                ...
                                                <div class="editBtn" onclick="document.location = '/admin/payment/updatePayment.php?id=<?php echo $payment->getId(); ?>'">
