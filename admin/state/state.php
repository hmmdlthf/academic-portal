        ...
        <div class="body">
            ...
            <div class="body__content">
                <?php if (count($states) > 0) { ?>
                    ...
                    <button class="btn btn__primary" onclick="document.location = '/admin/state/addState.php?link=add%20state'">Add New State</button>
                    <div class="items">
                        <table>
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <?php foreach ($states as $state) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="actions">
                                                <div class="deleteBtn" onclick="document.location = '/admin/state/deleteState.php?id=<?php echo $state->getId(); ?>'">
                                                ...
                                                <div class="editBtn" onclick="document.location = '/admin/state/updateState.php?id=<?php echo $state->getId(); ?>'">
